...
class ctl_fxdl extends common{
    ...
    public function __construct()
    {
        ...
        $this->_dbfield=array(
            'mainKey'=>'id',
           'allTableField'=>array('id'=>'编号','oid'=>'订单号','uid'=>'用户id','user_name'=>'用户账号','nickname'=>'用户昵称','paytype'=>'支付体系','data'=>'订单内容','money'=>'金额（元）','dl_money'=>'提成（元）','createtime'=>'订单时间','createtime_start'=>'订单开始时间','createtime_end'=>'订单结束时间','status'=>'支付状态','dl_status'=>'结算状态','paytime'=>'支付时间','paytime_start'=>'支付开始时间','paytime_end'=>'支付结束时间','ip'=>'ip','des'=>'标题','type'=>'栏目','trade_status'=>'第三方返回值'),
            'addTableField'=>array('oid','data','money','type'),
			
            'editTableField'=>array('paytype','data','money','status','dl_status'),
           
            'listTableField'=>array('uid','user_name','nickname','uid','oid','money','dl_money','status','dl_status','createtime','des'),
