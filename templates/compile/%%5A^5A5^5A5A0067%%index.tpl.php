...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'replace', 'admin/index.tpl', 46, false),)), $this); ?>
...
<body>
<div id="top_data">
    <div id="logo"><a href=""><img src="images/images/logo.png" alt="开运网通用后台" /></a></div>
    <div class="top-text">
