...
<div class="login_t">
<h3><span style="color:#0180cf">昵称：</span><{$member.nickname}></h3>
<span class="login_lj" style="font-size:14px;">我的佣金：<font color="red" size="3"><{$member.dl_syjf}></font> 元</span>
<span class="login_lj"><p style="margin:5px 0;font-size:14px;"><font color="red"><{if $member.class==1}>注册用户<{elseif $member.class==2}>微信用户<{elseif $member.class==2}>QQ用户<{else}>注册用户<{/if}></font>&nbsp;</p></span> </div>
</div>
