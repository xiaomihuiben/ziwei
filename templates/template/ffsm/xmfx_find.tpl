...
<div class="jieming_box J_payBottomShow ">
	...
	<div class="jb_content">
		<p class="n">
			<{$data.xing}><{$data.username}>（<{if $names.gender==1}>男<{else}>女<{/if}>）
		</p>
		<p>
...
<div class="jieming_box">
	...
	<div class="jb_bzmp">
		...
		<p class="words">
			从中医养生上来说，五行<font color="#ff4632"><{$return.info.tywh.wh}></font>旺人。
		</p>
		...
		<div class="jb_bzmp_bottom">
			...
			<p>
				<{$return.info.tywh.szwh}><br>
				<{$return.info.tywh.skzhyj}><br>
				<{$return.info.tywh.whzx}><br>
...
<div class="jieming_box">
	...
	<div class="jb_bzmp">
		<p class="words">
			三才总结：<span style="color: #ff4632"><{$return.rssancai.yy}></span>
		</p>
		<p class="jb_bzmp_bottom">
			<{$return.rssancai.content}>
		</p>
	</div>
</div>
