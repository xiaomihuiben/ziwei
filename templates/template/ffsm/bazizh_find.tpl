...
<audio src="https://www.03ky.com/m/video/bzjp_bottom.mp3" id="Atwo"></audio>
</div>
...
<div class="public_pay_popup" id="publicPayPopup" style="display:none;">
	<div class="public_pp_box">
		...
		<div class="public_pp_money"><img src="/statics/ffsm/bazijp/img/zenr.jpg" alt="服务内容"></div>
			<a class="public_pp_ljzf weixinzf" href="https://www.03ky.com/lb-2-1.html">立即发布悬赏</a>
...
.kefu_btn::before {content:'';width:30px;height:30px;background:url('http://csk.52ddtest.cn/statics/ffsm/bazijp/img/wen.png') no-repeat;background-size:100% 100%;display:inline-block;vertical-align:middle;margin-right:15px;margin-bottom:8px;}
...
//播放音频
        ...
        $('.dashi_point_box').on('click',function(){
            if($(this).attr('data-cid')=='one'){
                ...
                if($(this).hasClass('play')){
                    ...
                    $(this).addClass('play');
                    $('#myAudio').attr('src','https://www.03ky.com/m/video/bzjp_top.mp3');
                    audio.play();
                ...
                if($(this).hasClass('play')){
                    ...
                    $('.dashi_point_box').removeClass('play');
                    $(this).addClass('play');
                    $('#myAudio').attr('src','https://www.03ky.com/m/video/bzjp_bottom.mp3');
                    audio.play();
                    $(this).next('.dashi_audio_time').removeClass('newMsg');
                }
            }
        ...
        audio.addEventListener("play", function(){
            ...
            if($('#myAudio').attr('src')=='https://www.03ky.com/m/video/bzjp_top.mp3'){
                clearTimeout(clearTime);
                $('#Atwo').attr('src',"/statics/ffsm/bazijp/img/img_yuyin3.png");
                setTimeAnimation('#Aone');
            }
            if($('#myAudio').attr('src')=='https://www.03ky.com/m/video/bzjp_bottom.mp3'){
                clearTimeout(clearTime);
...
<div class="public_fyd_fengqing">
	...
	<div class="public_ff_goods">
		...
		<p>
			<span>微信号（开运网测算源码）</span>
		</p>
	</div>
	<div class="public_ff_text">
<p>
	开运网汇聚易学精英，微信关注《开运网测算源码》可以随时随地与权威命理大师一对一问答式服务。更有免费真人在线测试服务，详情敬请关注我们的微信公众号
</p>
...
<script>
	(function(){
		var num=['开运网测算源码','开运网测算源码','开运网测算源码'];
		var rNum=parseInt(Math.random()*num.length,10);
